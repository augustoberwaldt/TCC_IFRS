...
\begin{figure}  [h]
    ...
    \centerline{\includegraphics[width=20em]{figuras/download.jpg}}
...
\subsection{Lubax}
o sistema Lubax é um sistema de diagnóstico de doenças de pele. Ele funciona de forma semelhante a um livro de texto, onde você pode encontrar uma imagem que se parece com seu problema de pele \cite{LUBAX}. Mas enquanto observar isso em um livro de texto levaria muito tempo, Lubax faz isso em um instante. O algoritmo Lubax funciona um pouco como uma busca de imagens do Google. O Lubax atualmente só se encontra disponível para sistemas IOS, onde os usuários devem pagar para utilizar o sistema de diagnóstico.

\begin{figure}  [h]
   \caption{ Interface de usuário do Lubax}
    \centerline{\includegraphics[width=20em]{figuras/lubax-100713688-orig.jpg}}
...
\begin{figure}  [h]
   \caption{ Exemplo da arquitetura do django}
    \centerline{\includegraphics[width=20em]{figuras/arquiteturadjaongo.png}}
...
\begin{figure}  [h]
    ...
    \centerline{\includegraphics[width=20em]{figuras/img4.png}}
...
\caption{Arquitetura MVC}
    \centerline{\includegraphics[width=30em]{figuras/mvc_architectural_pattern.jpg}}
...
\begin{figure}  [h]
    \centerline{\includegraphics[width=35em]{figuras/ER.png}}
    \caption{Diagrama ER}
    \centerline{Fonte:autor}
\end{figure}
...
\begin{figure}  [h]
    \centerline{\includegraphics[width=30em]{figuras/casodeuso.png}}
...
\caption{Diagrama de atividade}
    \centerline{\includegraphics[width=40em]{figuras/atividade.png}}
...
\begin{figure}  [h]
  \caption{ Diagrama parcial de classes}
    \centerline{\includegraphics[width=30em]{figuras/parte_classe.png}}
...
\begin{figure}  [h]
   \caption{Trecho de código do login}
    \centerline{\includegraphics[width=1.0\textwidth]{figuras/login_codigo.png}}
...
\begin{figure}  [h]
   \caption{Tela de análise de imagem}
    \centerline{\includegraphics[width=0.5\textwidth]{figuras/diagnostico_ima.png}}
    \label{diagnosticimg}
    \centerline{Fonte:autor}
\end{figure}
...
\begin{figure}  [h]
 \caption{Trecho de código da requisição à API}
    \centerline{\includegraphics[width=0.8\textwidth]{figuras/codesvcimg.png}}
    \centerline{Fonte: autor}
    \label{codesvcimg}
\end{figure}
...
\begin{figure}  [h]
    ...
    \centerline{\includegraphics[width=0.5\textwidth]{figuras/ret_class_json.png}}
...
\begin{figure}  [h]
 \caption{Tela perfil usuário}
    \centerline{\includegraphics[width=30em]{figuras/sistema/perfil.png}}
...
\begin{figure}  [h]
 \caption{Tela de cadastro de classificador}
    \centerline{\includegraphics[width=30em]{figuras/sistema/cadastro_lista_class.png}}
...
\begin{figure} [h]
  \caption{Retorno da API}
    \centerline{\includegraphics[width=30em]{figuras/json_ibm.png}}
...
A matriz utiliza  uma tabela (com duas linhas e duas colunas) que relata o número de falsos positivos (FP), falsos negativos (FN),  verdadeiros positivos (VP) e verdadeiros negativos (VN). Podemos observar na Tabela \ref{mconfusao_melanoma} que na posição (x1, y1) encontra-se o VP,  na posição (x1, y2) encontra-se o FP, na posição (x2, y1) encontra-se FN, e por sua vez na posição (x2,y2) encontra-se o VN.
...
\begin{figure}  [h]
 \caption{Exemplo do  \textit{data augmentation} aplicado nas imagens das doenças }
    \centerline{\includegraphics[width=20em]{figuras/data_aug_melanoma.png}}
     \centerline{\includegraphics[width=30em]{figuras/data_augementation.png}}
    \label{classifierimg_aug}
    \centerline{Fonte:autor}
\end{figure}
